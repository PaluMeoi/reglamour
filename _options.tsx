import {Title, Text, Center, Stack, Group, TextInput, Button} from "@mantine/core"
    ...
    <ThemeProvider>
      <Stack justify="center" align="center">
        ...
        <form onSubmit={form.onSubmit(handleSubmit)}>
          <Stack>
            <TextInput label="Customization"
                       description="Default customizations to use for copying to glamourer"
                       key={form.key('customization')} {...form.getInputProps('customization')} />
            <Group>
              <Button type="submit">
                Save
              </Button>
